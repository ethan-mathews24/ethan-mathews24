...
![](websitematerial/royceinthegrass.jpg){.lightbox group="pups" fig-cap="Royce soaking up the sun." width="200"} ![](websitematerial/royceandphantom.jpg){.lightbox group="pups" fig-cap="Royce and Phantom together begging for food." width="200"} ![](websitematerial/mrandball.JPG){.lightbox group="pups" fig-cap="Phantom ready to pounce." width="200"} ![](websitematerial/royce.jpg){.lightbox group="pups" fig-cap="Royce looking regal." width="200"}
