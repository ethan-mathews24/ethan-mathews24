...
:::: {layout="[[1, 1, 1, 1]]"}
![](websitematerial/royceinthegrass.jpg){group="pups"
description="Royce soaking up the sun." width="200"}

![](websitematerial/royceandphantom.jpg){group="pups" 
description="Royce and Phantom together begging for food." width="200"}

![](websitematerial/mrandball.JPG){group="pups" 
description="Phantom ready to pounce." width="200"}

![](websitematerial/royce.jpg){group="pups" 
description="Royce looking regal." width="200"}
::::
...
::: {layout="[[1, 1, 1]]"}
![](websitematerial/phoebeingarden.jpg){group="phoebs" 
description="Phoebe in the garden." width="200"}

![](websitematerial/phoebeingrass.jpg){group="phoebs" 
description="Phoebe posing in the grass." width="200"}

![](websitematerial/phoebeatthebeach.JPG){group="phoebs" 
description="Phoebe watching me surf." width="200"}
:::
