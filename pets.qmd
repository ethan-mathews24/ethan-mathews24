...
![](websitematerial/perfectroyce.JPG){.lightbox group="pups" fig-cap="Royce (Miss Ma'am)" width="150"} ![](websitematerial/royceinthegrass.jpg){.lightbox group="pups" fig-cap="Royce soaking up the sun." width="200"} ![](websitematerial/royceandphantom.jpg){.lightbox group="pups" fig-cap="Royce and Phantom together begging for food." width="200"} ![](websitematerial/mrandball.JPG){.lightbox group="pups" fig-cap="Phantom ready to pounce." width="200"} ![](websitematerial/royce.jpg){.lightbox group="pups" fig-cap="Royce looking regal." width="200"} ![](websitematerial/mrsleeping.JPEG){.lightbox group="pups" fig-cap="Mr. sleeping peacefully." width="200"}

#### Queen Phoebe

::: {.lightbox-gallery cols="3"}
![](websitematerial/phoebeingarden.jpg){.lightbox group="pups" fig-cap="Phoebe in the garden." width="200"} ![](websitematerial/phoebeingrass.jpg){.lightbox group="pups" fig-cap="Phoebe posing in the grass." width="200"} ![](websitematerial/phoebeatthebeach.JPG){.lightbox group="pups" fig-cap="Phoebe watching me surf." width="200"}
:::
