...
![](media/moto.jpg){group="sports" description="Qualifying for State"}

![](media/skimboard.jpg){group="sports" description="Sunset Skimboard"}

![](media/snowboard.jpg){group="sports" description="My sister and I snowboarding in Switzerland"}

![](media/chip.jpg){group="sports" description="Potato Chip Rock"}
:::
