...
::: {layout="[[1, 1, 1, 1]]"}
![](media/snowboard.jpg){group="sports" description="My sister and I snowboarding in Switzerland" width="112"}

![](media/moto.jpg){group="sports" description="Qualifying for State" width="200"}

![](media/skimboard.jpg){group="sports" description="Sunset Skimboard" width="200"}

![](media/chip.jpg){group="sports" description="Potato Chip Rock" width="112"}
:::
...
#### Mammoth Mountain Park

::: {style="text-align: center;"}
<video width="640" controls> <source src="media/snowboard.mp4" type="video/mp4"> Your browser does not support the video tag. </video>
:::
