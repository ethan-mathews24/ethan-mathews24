...
![](media/lagoon.jpg){group="passion" description="UCSB Campus Lagoon"}

![](media/tidalzone.jpg){group="passion" description="Coal Oil Point - Golden Hour"}

![](media/lizard.jpg){group="passion" description="Lizard's Mouth, SB"}

![](media/rocks.jpg){group="passion" description="Sperling Preserve"}
:::
